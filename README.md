...
|**VENDOR_ID**|DATE|TIME|CATEGORY|QUALITY|COLOR|WIDTH|LENGTH|HEIGHT|PRICE|VIDEO_PATH|**O_PIC_PATH**|**C_PIC_PATH**|
|-------------|----|----|--------|-------|-----|-----|------|------|-----|----------|--------------|--------------|
|-**平台名称**-|----|----|--------|-------|-----|-----|------|------|-----|----------|-**解析生成**--|-**解析生成**-|
...
- 存储UserInput数据对应的表：从User方采集的数据尽量包含更详细的信息，初步拟定其包含的信息如下表所示：
  |USER_ID|DATE|CATEGORY|QUALITY|COLOR|WIDTH  |LENGTH |HEIGHT|EXP_PRICE|C_PIC_PATH_1|C_PIC_PATH_2|C_PIC_PATH_3|C_PIC_PATH_4|
  |-------|----|--------|-------|-----|-------|-------|------|---------|------------|------------|------------|------------|
  |USER_ID|日期|物品种类 |质量种类|颜色 |宽/内圈 |长/外圈|厚度   |EXP-价格 |PIC文件路径_1|PIC文件名称_2|PIC文件名称_3|PIC文件名称_4|
